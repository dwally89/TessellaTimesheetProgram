namespace TimesheetProgramLogic
{
    ...
    public abstract class ATimesheetManager
    {
        ...
        /// <param name="entry">The entry.</param>
        private void WriteEntry(StaffNumber staffNumber, List<string> lines, Entry entry)
        {
            ...
            sEntry += staffNumber.Number;
            sEntry += Util.AddSpaces(staffNumber.Number.ToString(), Entry.MAX_STAFF_NUMBER_LENGTH);
